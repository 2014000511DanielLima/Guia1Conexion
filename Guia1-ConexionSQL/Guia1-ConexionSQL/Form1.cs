...
namespace Guia1_ConexionSQL
{
    ...
    {
        SqlConnection conn = new SqlConnection(@"Data Source=LAB-C-PC-22\SQLEXPRESS; Initial Catalog=Producto; Integrated Security=true");
        public Form1()
        {
            InitializeComponent();
            ObtenerRegistros();
        ...
        {
            SqlConnection conexion = new SqlConnection(@"Data Source=LAB-C-PC-22\SQLEXPRESS; Initial Catalog=Producto; Integrated Security=true");
            conexion.Open();
